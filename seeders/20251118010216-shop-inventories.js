...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('ShopInventories', [
      {
        shop_inventory_id: 1, scroll_id: 1, quantity: 20,
      ...
      {
        shop_inventory_id: 6, scroll_id: 6, quantity: 20,
        purchase_price: 180.00, selling_price: 270.00, quality_rating: 9.00,
        acquired_date: new Date('2025-01-16'), createdAt: new Date(), updatedAt: new Date()
      },
      {
        shop_inventory_id: 7, scroll_id: 7, quantity: 5,
      ...
      {
        shop_inventory_id: 8, scroll_id: 8, quantity: 4,
