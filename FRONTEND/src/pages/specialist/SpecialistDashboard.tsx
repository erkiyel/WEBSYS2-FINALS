...
export default function SpecialistDashboard() {
  ...
  if (!user) return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-base-200 to-base-300" data-theme="luxury">
    <div className="text-center">
      ...
      <p className="mt-4 text-base-content/70">Loading your specialist dashboard...</p>
    </div>
  </div>;
    ...
    <div className="min-h-screen bg-gradient-to-br from-base-200 to-base-300" data-theme="luxury">
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-primary mb-3">Scroll Specialist Workshop</h2>
          <p className="text-base-content/70 text-lg">Manage your magical scroll inventory and orders</p>
        </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-base-content">My Inventory</h3>
              </div>
              <p className="text-base-content/70 mb-6">Manage your magical scroll collection, stock levels, and pricing</p>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-base-content">Seller Orders</h3>
              </div>
              <p className="text-base-content/70 mb-6">View and manage orders from scroll sellers</p>
